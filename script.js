...
// Ngăn click dâu tây lan ra ngoài icon
...
function showModal(text, emoji = "😡", callback = null) {
...
function startGame() { 
    ...
    showModal("Luật chơi: Anh có 3 mạng. Trả lời sai mất 1 mạng. Hết mạng chơi lại từ đầu!", "📜", nextQ); 
